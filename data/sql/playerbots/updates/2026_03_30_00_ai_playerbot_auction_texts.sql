...
(1745, 'auction_no_auctioneers_nearby', 'There are no auctioneers nearby', 0, 0,
'', '', '', '', '', '', '', ''),

(1746, 'auction_sell_usage_error', 'Usage: s gray/*/vendor/auction/[item link]', 0, 0,
'', '', '', '', '', '', '', ''),

(1747, 'travel_target_activity_auction_house', 'auction house', 0, 0,
'', '', '', '', '', '', '', ''),

(1748, 'auction_buy_success', 'Buying from auction house %item_link for %cost', 0, 0,
'', '', '', '', '', '', '', ''),

(1749, 'auction_sell_success', 'Posting to auction house %item_link for %start_bid..%buyout', 0, 0,
'', '', '', '', '', '', '', '');
